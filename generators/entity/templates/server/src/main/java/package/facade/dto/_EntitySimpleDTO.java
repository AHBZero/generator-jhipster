...
<% if (databaseType === 'sql') { %>
    ...
    public boolean equals(Object o) {
        ...
        <%= entityClass %>SimpleDTO <%= entityInstance %>SimpleDTO = (<%= entityClass %>SimpleDTO) o;
        if(<%= entityInstance %>SimpleDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), <%= entityInstance %>SimpleDTO.getId());
    }
