...
import static <%=packageName%>.service.util.ObjectId.Assertions.isTrueArgument;
import static <%=packageName%>.service.util.ObjectId.Assertions.notNull;
...
public final class ObjectId implements Comparable<ObjectId>, Serializable {
    ...
    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(UserResource.class);
