 ...
 *
 * <p>
 * There are cases when a request is acceptByCustomer and the message successfully
 * created, but GCM has a canonical registration id for that device. In this
 * case, the server should updateByCustomerRequest the registration id to avoid rejected requests
 * in the future.
 *
 * <p>
 ...
 *         - otherwise, updateByCustomerRequest the server datastore with the new id.
 * </pre>
 */
